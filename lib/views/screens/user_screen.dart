                                      ...
                                      child: Theme(
                                        ...
                                        child: PaginatedDataTable(
                                          ...
                                          columns: [
                                            ...
                                            DataColumn(label: Text('Name'),onSort: (columnIndex, _){
                                              setState(() {
                                                _currentSortColumn = columnIndex;
                                                if (_isAscending == true) {
                                                  _isAscending = false;
                                                  // sort the product list in Ascending, order by Price
                                                  usermodelList.sort((productA, productB) =>
                                                      productB.uName!.compareTo(productA.uName!));
                                                } else {
                                                  _isAscending = true;
                                                  // sort the product list in Descending, order by Price
                                                  usermodelList.sort((productA, productB) =>
                                                      productA.uName!.compareTo(productB.uName!));
                                                }
                                              });
                                            }),
